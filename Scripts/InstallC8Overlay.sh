...
REQUIRE_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/bin/cellscan.sh status"' "C8 base station scan status RPC permission"
REQUIRE_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/bin/cellscan.sh start"' "C8 base station scan start RPC permission"
REQUIRE_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/bin/cellscan.sh stop"' "C8 base station scan stop RPC permission"
REQUIRE_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/share/modem/luci-reinit.sh"' "C8 modem apply RPC permission"
REJECT_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/bin/sendat 2 \*"' "broad sendat RPC permission"
REJECT_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/bin/cellscan.sh \*"' "broad cellscan RPC permission"
REJECT_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/bin/iwinfo \*"' "unused iwinfo RPC permission"
REJECT_PATTERN "$OVERLAY_DST/usr/share/rpcd/acl.d/luci-app-c8modem.json" '"/usr/share/modem/rm520n.sh"' "direct modem init RPC permission"
